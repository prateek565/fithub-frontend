...
function RazorPay() {
  ...
  const fetchOrder = async () => {
    try {
      const data = await axios.get("https://fitness-hub-backend.onrender.com/payment/list-order")
      .then((res)=> {
 ...
 // }, []);
  ...
  const handlePay = () => {
    ...
    script.onload = async () => {
        ...
        try {
        setLoading(true);
        const result = await axios.post("https://fitness-hub-backend.onrender.com/payment/create-order", {
          amount: total + "00"
        });
        ...
        const getkey = await axios.get(
          "https://fitness-hub-backend.onrender.com/payment/get-razorpay-key"
        );
        ...
        const options = {
          ...
          handler: async function (response) {
            const result = await axios.post("https://fitness-hub-backend.onrender.com/payment/pay-order", {
              amount: amount,
